...
if(isset($_POST['button']))
{
    ...
    $sql_query = "SELECT User_ID, FULL_NAME, USER_NAME, USER_TYPE, EMAIL, IMAGE, BIO, FOLLOWERS, FOLLOWING, POSTS  FROM USERS WHERE (USER_NAME = '$fisrt_parm' OR EMAIL = '$fisrt_parm') AND PASSWORD_S = '$password';";
    ...
    if($stmt->num_rows() > 0)
    {
        $stmt->bind_result($user_id, $full_name, $user_name, $user_type, $email_address, $image,  $bio, $fallowers, $fallowing, $post_count);
