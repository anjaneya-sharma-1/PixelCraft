...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
  ...
  <div class="w3-display-middle">
    ...
    <h1 class="w3-jumbo w3-animate-top"><img class="mb-4" src="assets/images/login_request/small_logo2.png" alt="" height="100"></h1>

    <hr class="w3-border-grey" style="margin:auto;width:40%">

    <p class="w3-large w3-center">Community Pinboard</p>
